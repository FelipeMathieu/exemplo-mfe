...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-DYlhdcjt.js', import.meta.url).href),import:true,requiredVersion:'^18.3.1'},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-9ckuU_Vx.js', import.meta.url).href),import:true},'single-spa-react':{get:()=>()=>__federation_import(new URL('__federation_shared_single-spa-react-BbWmaWt9.js', import.meta.url).href),import:true},'@tanstack/react-query':{get:()=>()=>__federation_import(new URL('__federation_shared_@tanstack/react-query-BjhkcQva.js', import.meta.url).href),import:true,requiredVersion:'^5.59.0'},'zustand':{get:()=>()=>__federation_import(new URL('__federation_shared_zustand-DZ_1v67p.js', import.meta.url).href),import:true,requiredVersion:'^5.0.0-rc.2'}};
